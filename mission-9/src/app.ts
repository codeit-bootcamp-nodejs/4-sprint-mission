...
const ACCESS_TOKEN_SECRET = process.env.ACCESS_TOKEN_SECRET_KEY; // Use the correct secret key
if (!ACCESS_TOKEN_SECRET) {
  throw new Error("ACCESS_TOKEN_SECRET_KEY is not set in the environment variables.");
}
