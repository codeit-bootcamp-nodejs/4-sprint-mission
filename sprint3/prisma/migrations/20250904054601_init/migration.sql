...
-- CreateIndex
CREATE UNIQUE INDEX "Comment_id_articleId_key" ON "public"."Comment"("id", "articleId");

-- CreateIndex
CREATE UNIQUE INDEX "Comment_id_productId_key" ON "public"."Comment"("id", "productId");
