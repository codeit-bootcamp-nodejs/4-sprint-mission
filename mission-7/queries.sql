...
*/
-- INSERT INTO "User" (email, nickname, password) VALUES ('test@test.com', 'user1', '12345678a');
...
/*
  ...
  - 현재 로그인한 유저 id가 1이라고 가정
*/
SELECT COUNT(*) AS "총 개수" FROM "Product" WHERE "userId" = 1; 
...
/*
  ...
  - 현재 로그인한 유저 id가 1이라고 가정
*/
INSERT INTO "Product" (name, description, price, tags, "userId") VALUES ('테스트 상품', '테스트입니다.', 50000, ARRAY['test1', 'test2'], 1);
...
/*
  ...
  - 1번 상품 수정
*/
UPDATE "Product" SET name = 'test 상품 수정' WHERE id = 1;
...
/*
  ...
  - 1번 유저가 2번 상품 좋아요 취소
*/
DELETE FROM "ProductLike" WHERE "userId" = 1 and "productId" = 2;

/*
  13. 상품 댓글 작성
  - 1번 유저가 2번 상품에 댓글 작성
*/
INSERT INTO "Comment" (content, "userId", "productId") VALUES ('테스트 댓글 입니다.', 1, 2);
