...
import { CreateArticle, PatchArticle, CreateComment } from '../validators/structor.js';
...
router.get('/', asyncHandler(async (req, res) => {
  const { order = 'asc', page = 1, pageSize = 5, keyword = '' } = req.query;
...
router.post('/:aid/comments', asyncHandler(async (req, res) => {
...
router.get('/:aid/comments', asyncHandler(async (req, res) => {
  const { aid } = req.params;
