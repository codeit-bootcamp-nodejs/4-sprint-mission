...
function ProductValid(req, res, next) {
    var _a = req.body, name = _a.name, description = _a.description, price = _a.price, tags = _a.tags;
    try {
...
var ProductMiddleware = /** @class */ (function () {
    function ProductMiddleware() {
        ...
        this.validateForm = function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            var _a, name, description, price, tags, err;
        ...
        this.validateCommentId = function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            var CommentId, err;
            return __generator(this, function (_a) {
