...
SELECT COUNT(*) AS total_product_like
FROM product_like
WHERE user_id = 1;
...
VALUES (1,'아이폰17','미개봉 상품입니다', 15000000);
...
UPDATE products 
SET name = '상품 수정', description = '설명 수정', price = 10000
WHERE id = 1;
...
INSERT INTO product_like (user_id, product_id) VALUES (1, 2);
...
DELETE FROM product_like WHERE user_id = 1 AND product_id = 2;
