...
export async function commentListController(req, res, next) {
  try {
    ...
    const list =  await commentListService.commentList(userId)
...
export async function commentRegisterProductController(req, res, next) {
  try {
    ...
    // 서비스 로직
    const createdComment = await commentRegisterProductService.commentRegisterProduct(
      userId,
      productId,
      content
    );
...
export async function commentRegisterPostController(req, res, next) {
  try {
    ...
    // 서비스 로직
    const createdComment = await commentRegisterPostService.commentRegisterPost(
      userId,
      postId,
      content
    );
...
export async function commentPutController(req, res, next) {
  try {
    ...
    // 서비스 로직
    const updatedComment = await commentPutService.commentPut(userId, commentId, content);
...
export async function commentDeleteController(req, res, next) {
  try {
    ...
    // 서비스 로직
    const deletedComment = await commentDeleteService.commentDelete(userId, commentId);
