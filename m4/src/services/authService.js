...
export const findUserAndVerifyPassword = async (email, password) => {
...
export const refresh = async (refreshTokenFromClient) => {
    return prisma.$transaction(async (tx) => {
...
export const logout = async (refreshTokenFromClient) => {
    return prisma.$transaction(async (tx) => {
