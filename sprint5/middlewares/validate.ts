...
export function validateArticleCreate(
  req: Request,
  res: Response,
  next: NextFunction
) {
...
export function validateArticleQuery(
  req: Request,
  res: Response,
  next: NextFunction
) {
...
export function validateCommentUpdate(
  ...
  if (commentId === null || isNaN(commentId) || !content) {
...
// 인증 미들웨어: req.user가 없으면 401 오류 처리
