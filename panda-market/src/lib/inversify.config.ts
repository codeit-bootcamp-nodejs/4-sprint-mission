...
// strategies
container.bind(TYPES.S3UploadStrategy).to(S3UploadStrategy).inSingletonScope();
container
  .bind(TYPES.CloudinaryUploadStrategy)
  .to(CloudinaryUploadStrategy)
  .inSingletonScope();
...
container
  ...
  .inSingletonScope();
container
  .bind(TYPES.ArticleImageRepository)
  .to(ArticleImageRepository)
  .inSingletonScope();
container
  .bind(TYPES.ArticleLikeRepository)
  .to(ArticleLikeRepository)
  .inSingletonScope();
container
  .bind(TYPES.ProductCommentRepository)
  .to(ProductCommentRepository)
  .inSingletonScope();
container
  .bind(TYPES.ArticleCommentRepository)
...
container
  .bind(TYPES.ProductLikeService)
  .to(ProductLikeService)
  .inSingletonScope();
container
  .bind(TYPES.ArticleLikeService)
  .to(ArticleLikeService)
  .inSingletonScope();
container
  .bind(TYPES.ProductCommentService)
  .to(ProductCommentService)
  .inSingletonScope();
container
  .bind(TYPES.ArticleCommentService)
  .to(ArticleCommentService)
  .inSingletonScope();
container
...
container
  ...
  .inSingletonScope();
container
  .bind(TYPES.ProductCommentController)
  .to(ProductCommentController)
  .inSingletonScope();
container
  .bind(TYPES.ArticleCommentController)
...
container
  .bind(TYPES.ArticleController)
  .to(ArticleController)
  .inSingletonScope();
container
  .bind(TYPES.NotificationController)
