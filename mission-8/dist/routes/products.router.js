...
/** 상품 등록 **/
router.post('/products', authMiddleware, validationMiddleware(CreateProductDto), productsController.createProduct);
/** 상품 목록 조회 **/
router.get('/products', productsController.getProducts);
/** 상품 상세 조회 **/
router.get('/products/:productId', optionalAuthMiddleware, productsController.getProductById);
/** 상품 수정 **/
router.put('/products/:productId', authMiddleware, validationMiddleware(UpdateProductDto), productsController.updateProduct);
/** 상품 삭제 **/
