...
router.get("/products/:id", passport.authenticate("access-token", { session: false }), controller.productCommentList);
router.get("/articles/:id", passport.authenticate("access-token", { session: false }), controller.articleCommentList);
