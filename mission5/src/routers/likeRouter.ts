...
async function likeArticle(req: Request, res: Response, next: NextFunction) {
...
async function likeProduct(req: Request, res: Response, next: NextFunction) {
  if (!req.user) return res.status(401).json({ message: "Unauthorized" });
  const user = req.user;
...
async function getLikedArticles(req: Request, res: Response, next: NextFunction) {
  if (!req.user) return res.status(401).json({ message: "Unauthorized" });
  const user = req.user;
...
async function getLikedProducts(req: Request, res: Response, next: NextFunction) {
  if (!req.user) return res.status(401).json({ message: "Unauthorized" });
  const user = req.user;
