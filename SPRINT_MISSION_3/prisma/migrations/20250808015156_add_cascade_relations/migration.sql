...
-- AddForeignKey
ALTER TABLE "public"."Product" ADD CONSTRAINT "Product_articleId_fkey" FOREIGN KEY ("articleId") REFERENCES "public"."Article"("id") ON DELETE CASCADE ON UPDATE CASCADE;
