...
FROM 
    orders
WHERE 
    EXTRACT(MONTH FROM DATE) = 3 AND EXTRACT(YEAR FROM DATE) = 2025;
...
FROM 
    orders
WHERE 
    DATE = '2025-03-12' AND TIME < '12:00:00'; 
...
FROM 
    pizza_types
WHERE
    name LIKE '%Cheese%' OR name LIKE '%Chicken%';
